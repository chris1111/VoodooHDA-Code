...
#define HDA_INTEL_SER8HDMI          HDA_MODEL_CONSTRUCT(INTEL, 0x0c0c)
...
#define HDA_INTEL_WPT1        HDA_MODEL_CONSTRUCT(INTEL, 0x8ca0)
#define HDA_INTEL_WELLSBURG1    HDA_MODEL_CONSTRUCT(INTEL, 0x8d20)
#define HDA_INTEL_WELLSBURG2    HDA_MODEL_CONSTRUCT(INTEL, 0x8d21)
...
#define HDA_INTEL_UNPT        HDA_MODEL_CONSTRUCT(INTEL, 0xa2f0)
...
#define HDA_ATI_BONAIR			HDA_MODEL_CONSTRUCT(ATI, 0xaab8)
#define HDA_ATI_TAHITI			HDA_MODEL_CONSTRUCT(ATI, 0xaac0)
#define HDA_ATI_HAWAII			HDA_MODEL_CONSTRUCT(ATI, 0xaac8)
#define HDA_ATI_BUFFIN      HDA_MODEL_CONSTRUCT(ATI, 0xaae0)
#define HDA_ATI_VEGA        HDA_MODEL_CONSTRUCT(ATI, 0xaaf0)
...
#define DELL_I1525_SUBVENDOR      HDA_MODEL_CONSTRUCT(DELL, 0x022f)
